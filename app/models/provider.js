...
//Start add new field -16th mar -2021
domain_name: {type: String, default: "Google"},
//End add new field -16th mar -2021
    ...
    ssn_no: {type: String, default: ""},
    body_temperature: {type: String, default: ""},
...
provider.plugin(AutoIncrementID, {model: 'provider', field: 'unique_id', startAt: 1, incrementBy: 1});
