...
var Trip = new Schema({
    ...
    is_current_appointment: {type: Number, default: 0},

    refund_amount: {type: Number, default: 0},
    is_amount_refund: {type: Boolean, default: false},
    requisition_num: {type: String, default: ""},
...
Trip.plugin(AutoIncrementID, {model: 'Trip', field: 'unique_id', startAt: 1, incrementBy: 1});
