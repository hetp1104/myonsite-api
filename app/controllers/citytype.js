    ...
    utils.check_request_params(req.body, [
        ...
        if (response.success) {
            ...
            table.findOne({_id: id}).then((detail) => {
                ...
                Country.findOne({$and: [{$or: [{countryname: country}, {alpha2: country_code}]}, {isBusiness: constant_json.YES}]}).then((country) => {
...
exports.disptcher_city_type_list = function (req, res) {
    ...
    utils.check_request_params(req.body, [
        ...
        if (response.success) {
            ...
            Country.findOne({$and: [{$or: [{countryname: subAdminCountry}, {alpha2: req.body.country_code}]}, {isBusiness: constant_json.YES}]}).then((country) => {
