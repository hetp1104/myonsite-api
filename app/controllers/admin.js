...
exports.getappkeys = function (req, res, next) {
    Settings.findOne({}).then((setting) => { 
        ...
        var user_terms_and_condition_url = req.protocol + '://' + req.get('host') + "/user_terms"; // Added user terms and condition URL
        ...
        if (!setting) {
            ...
            res.json({
                ...
                user_terms_and_condition_url: user_terms_and_condition_url, // Added user terms and condition URL
