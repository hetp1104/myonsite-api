...
module.exports = function (app) {
    ...
    /////////////////////////////////////////
    //app.route('/insert_update_phlebotomist').post(providers.insert_update_phlebotomist);

    // // Add route for adding expenses
    // app.route('/add_expense').post(providers.submitExpense);
};