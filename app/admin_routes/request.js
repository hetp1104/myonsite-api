...
module.exports = function (app) {
    ...
    app.route('/trip_detail').post(requests.trip_detail);
    ...
    app.route('/all_requests').get(requests.list_all);
    app.route('/all_requests').post(requests.list_all);

    app.route('/getSchedulesList').get(requests.getSchedulesList);
    app.route('/getTodaySchedules').get(requests.getTodaySchedules);
};
