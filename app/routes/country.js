...
module.exports = function (app) {
    ...
    app.route('/getCountryStateCities').get(country.getCountryStateCities);
    app.route('/getCitiesByStatecode').post(country.getCitiesByStatecode);
    app.route('/getCountryDetail').post(country.getCountryDetail);
